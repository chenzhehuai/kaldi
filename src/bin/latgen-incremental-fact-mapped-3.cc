// bin/latgen-incremental-fact-mapped-ctc.cc
...
int main(int argc, char *argv[]) {
  try {
    ...
    po.Register("hmm-fst", &hmm_fst_in_str, "Generated by make-h-transducer-fact.");
    ...
    if (ClassifyRspecifier(fst_in_str, NULL, NULL) == kNoRspecifier) {
      ...
      {
        KALDI_ASSERT(hmm_fst_in_str != "");
        LatticeIncrementalFactDecoderTpl<fst::StdFst, 3> decoder(config, decode_fst, &trans_model, hmm_fst_in_str);
        ...
        for (; !loglike_reader.Done(); loglike_reader.Next()) {
          ...
          double like;
          if (DecodeUtteranceLatticeIncremental<Fst<StdArc>, LatticeIncrementalFactDecoderTpl<fst::StdFst, 3>>(
      ...
      for (; !fst_reader.Done(); fst_reader.Next()) {
        ...
        LatticeIncrementalFactDecoder decoder(config, &fst, &trans_model, hmm_fst_in_str);
        DecodableMatrixScaledMapped decodable(trans_model, loglikes, acoustic_scale);
        double like;
        if (DecodeUtteranceLatticeIncremental<Fst<StdArc>, LatticeIncrementalFactDecoder>(
