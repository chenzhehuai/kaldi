...
#ifndef KALDI_FSTEXT_CONTEXT_AFST_H_
#define KALDI_FSTEXT_CONTEXT_AFST_H_
...
inline void ComposeContext(const vector<int32> &disambig_syms,
                           const vector<int32> &dis2phone_map,
                           int N, int P,
...
#include "context-afst-inl.h"

#endif  // KALDI_FSTEXT_CONTEXT_AFST_H_
