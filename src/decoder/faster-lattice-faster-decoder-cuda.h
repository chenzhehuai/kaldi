...
#ifndef KALDI_FASTER_LATTICE_FASTER_DECODER_CUDA_H_
#define KALDI_FASTER_LATTICE_FASTER_DECODER_CUDA_H_
...
#include "cuda-lattice-faster-decoder.h"
 ...
 */
class FasterLatticeFasterDecoderCuda {
 public:
  ...
  ~FasterLatticeFasterDecoderCuda();
 ...
 private:
  ...
  KALDI_DISALLOW_COPY_AND_ASSIGN(FasterLatticeFasterDecoderCuda);
};
