// decoder/faster-lattice-faster-decoder-cuda.cc
...
FasterLatticeFasterDecoderCuda::FasterLatticeFasterDecoderCuda(const CudaFst &fst,
    const CudaLatticeFasterDecoderConfig &config):
...
FasterLatticeFasterDecoderCuda::~FasterLatticeFasterDecoderCuda() {
...
// CPU decoding init
void FasterLatticeFasterDecoderCuda::InitDecoding() {
...
bool FasterLatticeFasterDecoderCuda::Decode(DecodableInterface *decodable) {
  ...
  // (which isn't allowed).
  PUSH_RANGE("CudaLatticeFasterDecoder::Decode",1)
  ...
  FinalProcessLattice(toks_buf, toks_sidx, arcs_buf, arcs_size,
                      num_frames_decoded_);
...
inline FasterLatticeFasterDecoderCuda::Token* FasterLatticeFasterDecoderCuda::
...
inline bool FasterLatticeFasterDecoderCuda::CreateAndLinkTok(BaseFloat cost,
...
inline int32 FasterLatticeFasterDecoderCuda::AddLatticeArcs(int32 proc_frame) {
...
void FasterLatticeFasterDecoderCuda::FinalProcessLattice(
...
bool FasterLatticeFasterDecoderCuda::GetBestPath(Lattice *olat,
...
// tracebacks. :
bool FasterLatticeFasterDecoderCuda::GetRawLattice(Lattice *ofst,
    bool use_final_probs) const {
...
void FasterLatticeFasterDecoderCuda::FinalizeDecoding() {
...
void FasterLatticeFasterDecoderCuda::PruneForwardLinks(
...
void FasterLatticeFasterDecoderCuda::PruneForwardLinksFinal() {
...
BaseFloat FasterLatticeFasterDecoderCuda::FinalRelativeCost() const {
...
void FasterLatticeFasterDecoderCuda::PruneTokensForFrame(int32 frame_plus_one) {
  KALDI_ASSERT(frame_plus_one >= 0 && frame_plus_one < active_toks_.size());
...
void FasterLatticeFasterDecoderCuda::PruneActiveTokens(BaseFloat delta) {
...
void FasterLatticeFasterDecoderCuda::ComputeFinalCosts(
...
void FasterLatticeFasterDecoderCuda::ClearActiveTokens() { // a cleanup routine, at utt end/begin
...
// static
void FasterLatticeFasterDecoderCuda::TopSortTokens(Token *tok_list,
