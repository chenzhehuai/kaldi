// decoder/lattice-faster-const-decoder.h
...
#ifndef KALDI_DECODER_LATTICE_CONST_FASTER_DECODER_H_
#define KALDI_DECODER_LATTICE_CONST_FASTER_DECODER_H_
...
class LatticeConstFstFasterDecoder {
 ...
 private:
  ...
  struct Token {
    ...
    // there is a comment in lattice-faster-const-decoder.cc explaining this;
  ...
  const fst::ConstFst<fst::StdArc> &fst_;
  bool delete_fst_;
